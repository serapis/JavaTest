...
//        for(String a:filterGetStringArray(getMotherboardSN())){
//        System.out.print(a);
//        }
        System.out.println(filterGetString(getMotherboardSN()));

        md5 md51 = new md5();
        md51.md5s(filterGetString(getMotherboardSN()));


    }

    public static String[] filterGetStringArray(String snNumber)
    {
...
//
        ...
        String[] numLetter =new String[result.size()];
        for(int j=0;j<result.size();j++)
        {
              numLetter[j]          = result.get(j);
